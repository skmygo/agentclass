...
// h1 可見、molab 連結格式正確、.py 下載連結真的拿得到檔案、課末測驗可作答、console 無錯誤。
...
const H1_TEXT = "MLflow Models 與 Model Registry";        // 【必改】課程頁 hero 的 h1 文字（可只取片段）
const EXT_FILE = "mlflow-registry_ext.py"; // 【scaffold 代換】外部 notebook 檔名
