...
const H1_TEXT = "Claude Agent SDK：把 Claude Code 裝進你的程式（實驗場）"; // notebook 第一個 md cell 的 h1 文字
const MIN_FIGURES = 2;               // 全部 cell 跑完會出現的 img/canvas 數量（1️⃣ 六次比較圖、3️⃣ token 帳）
