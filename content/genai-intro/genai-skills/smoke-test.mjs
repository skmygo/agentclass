...
const H1_TEXT = "Agent Skills：把 SOP 打包成 AI 的技能（實驗場）"; // notebook 第一個 md cell 的 h1 文字
const MIN_FIGURES = 4;               // 全部 cell 跑完會出現的 img/canvas 數量（= index.html 的 data-ready-figures）
