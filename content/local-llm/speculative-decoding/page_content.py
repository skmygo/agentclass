...
<section id="hero">
  ...
  <p class="note">
    ...
    右邊會把同一件事跑三萬輪、跟公式對答案。玩壞了重新整理就復原——盡量玩。
  </p>
</section>
...
<section id="s8">
  ...
  <p>盯三個數字：</p>
  <ul>
    <li><b>Output token throughput</b>——總產能（實驗場 4️⃣ 的下圖）。</li>
    <li><b>Mean TPOT</b>——每人 token 間隔，也就是體感速度（4️⃣ 的上圖）。</li>
...
<section id="s9">
  ...
  <div class="ex">
    ...
    <p>4️⃣ 那根「每個序列每個位置的計算時間」拉到 0.01——
...
<section id="quiz">
  ...
  --speculative-config '{"method":"draft_model",
    ...
    <div class="quiz-q" data-answer="B">
      ...
      <h3>有人量到自己的接受率只有 0.6、草稿模型單步成本約大模型的 30%。他想「那我多猜一點就好」，把 K 從 5 調到 12，結果更慢了。右邊的實驗區算出來是這樣——為什麼？</h3>
